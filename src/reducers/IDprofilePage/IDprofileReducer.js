...
export const GET_IDPAGE_INFO = 'my-awesome-app/repos/INFO';
export const GET_IDPAGE_INFO_SUCCESS = 'my-awesome-app/repos/INFO_SUCCESS';
export const GET_IDPAGE_INFO_FAIL = 'my-awesome-app/repos/INFO_FAIL';
...
export function getIDpage(user, repo) {
  return {
    type: GET_REPO_INFO,
    payload: {
      request: {
